class Veronese < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/adusingi/veronese-cli/releases/download/v0.1.0/veronese_v0.1.0_darwin_arm64.tar.gz"
      sha256 "24563d24d3c9c445040f6891a87375785a39142e12fa0cb6570d7fbb471f4c53"
    end
    on_intel do
      url "https://github.com/adusingi/veronese-cli/releases/download/v0.1.0/veronese_v0.1.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/adusingi/veronese-cli/releases/download/v0.1.0/veronese_v0.1.0_linux_arm64.tar.gz"
      sha256 "a607eaa9b0d3dc9f57055772400996332f4493168af460d3f57ba738434f7092"
    end
    on_intel do
      url "https://github.com/adusingi/veronese-cli/releases/download/v0.1.0/veronese_v0.1.0_linux_amd64.tar.gz"
